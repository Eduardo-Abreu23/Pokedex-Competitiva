...
// node_modules/@pkmn/sets/build/index.mjs
function toID(s) {
...
var Sets = new class {
  ...
  exportSet(s, data) {
    ...
    if (s.teraType) {
      ...
      buf += "Tera Type: " + (s.teraType || (d == null ? void 0 : d.requiredTeraType) || ((_f = d == null ? void 0 : d.types) == null ? void 0 : _f[0])) + "  \n";
    }
    let first = true;
  ...
  fromJSON(json) {
    if (!json.startsWith("{") || !json.endsWith("}")) return void 0;
...
function unpackName(name, data) {
  ...
  if (data) {
    ...
    if (obj == null ? void 0 : obj.exists) return obj.name;
  }
...
//# sourceMappingURL=@pkmn_sets.js.map
